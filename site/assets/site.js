...
(function () {
  ...
  <svg width="30" height="30" viewBox="0 0 30 30" aria-hidden="true">
    ...
    nav: [
      ...
      { t: 'Практикум', h: 'lab', drop: [
        { h: 'lab', k: 'lab', t: 'Лабораторный практикум' },
        { h: 'l-solution', k: 'lab', t: '1. Приготовление раствора' },
        { h: 'l-titration', k: 'lab', t: '2. Кислотно-основное титрование' },
        { h: 'l-ions', k: 'lab', t: '3. Качественные реакции' },
        { h: 'l-hardness', k: 'lab', t: '4. Жёсткость воды' },
        { h: 'l-kinetics', k: 'lab', t: '5. Скорость реакции' },
        { h: 'l-electrochem', k: 'lab', t: '6. Электрохимия' },
        { h: 'l-redox', k: 'lab', t: '7. Реакции ОВР и среда' },
      ] },
